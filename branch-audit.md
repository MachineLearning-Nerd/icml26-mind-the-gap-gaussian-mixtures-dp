...
Before identity normalization, this repository had one publication branch and eleven remote experiment branches. Every former branch tip was an ancestor of the pre-identity-normalization publication tip 527c9343d00a42231e32fdb3b5b24a7964ec4b22. The experiment history therefore remains reachable through the rewritten main history after the branch pointers are retired.

| Former branch | Pre-normalization tip | Purpose and recorded outcome | Disposition |
| --- | --- | --- | --- |
| main | 527c9343d00a42231e32fdb3b5b24a7964ec4b22 | Final publication surface, exact Table 1 aggregate, claim ledger, and release artifacts. | Keep as canonical main |
...
The orx/* names were generated experiment labels, not stable public APIs. The normalized public surface uses only main; the claim pages, raw evidence, commit history, and this audit preserve the experiment purposes and outcomes. The listed experiment SHAs are historical pre-normalization identifiers; corresponding rewritten commits are reachable from main.

Identity normalization is complete. Every reachable commit is attributed to MachineLearning-Nerd <MachineLearning-Nerd@users.noreply.github.com>; no pending rewrite or public experiment branch remains.
