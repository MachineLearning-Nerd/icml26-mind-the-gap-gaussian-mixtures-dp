...
def notebook_check() -> dict[str, object]:
    notebook = ROOT / "notebooks" / "mind_the_gap_reproduction.py"
    completed = subprocess.run(
        [str(ROOT / ".venv" / "bin" / "marimo"), "check", str(notebook)],
        cwd=ROOT,
        capture_output=True,
        text=True,
    )
